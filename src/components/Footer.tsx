      ...
      <div className="container py-10 px-5 grid gap-8 sm:grid-cols-3 items-start">
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-4">
            <Link to="#" aria-label="Twitter" className="hover:text-white" title="Twitter">
            ...
            <Link to="#" aria-label="Instagram" className="hover:text-white" title="Instagram">
            ...
            <Link to="#" aria-label="Facebook" className="hover:text-white" title="Facebook">
